...
PROGMEM const animationFrame animationData[21][9]= {
	...
	{{SUNGLASSES, 5000}, },
	{{NEKO, 5000}, },
	{{BUFFERING1, 80}, {BUFFERING2, 80}, {BUFFERING3, 80}, {BUFFERING4, 80}, {BUFFERING5, 80}, {BUFFERING6, 80}, {BUFFERING7, 80}, {BUFFERING8, 80}, },
	{{OWO, 5000}, },
	{{SLEEPING, 5000}, },
	{{RAINBOW, 5000}, },
	{{SCREENTEST, 5000}, },
	...
	{{SURPRISED, 5000}, },
	{{BLANK, 5000}, },
	{{HYPNO1, 130}, {HYPNO2, 130}, {HYPNO3, 130}, },
	{{BLUSH, 5000}, },
	{{HEART1, 400}, {HEART2, 250}, },
	{{SUS1, 150}, {SUS2, 150}, {SUS3, 600}, {SUS2, 150}, {SUS1, 150}, {SUS4, 150}, {SUS5, 600}, {SUS4, 150}, },
	{{SAD, 5000}, },
	{{HMM, 5000}, },
	{{VEXED, 5000}, },
	{{IRRITATED, 5000}, },
